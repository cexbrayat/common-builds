 ...
 * found in the LICENSE file at https://angular.io/license
 */
var HttpStandardUrlParameterCodec=function(){function HttpStandardUrlParameterCodec(){}return HttpStandardUrlParameterCodec.prototype.encodeKey=function(k){return standardEncoding(k)},HttpStandardUrlParameterCodec.prototype.encodeValue=function(v){return standardEncoding(v)},HttpStandardUrlParameterCodec.prototype.decodeKey=function(k){return decodeURIComponent(k)},HttpStandardUrlParameterCodec.prototype.decodeValue=function(v){return decodeURIComponent(v)},HttpStandardUrlParameterCodec}(),HttpUrlEncodedBody=function(){function HttpUrlEncodedBody(options){void 0===options&&(options={}),this.updates=null,this.cloneFrom=null,this.__HttpUrlEncodedBody=!0,this.encoder=options.encoder||new HttpStandardUrlParameterCodec,this.map=options.fromString?paramParser(options.fromString,this.encoder):null}return HttpUrlEncodedBody.prototype.has=function(param){return this.init(),this.map.has(param)},HttpUrlEncodedBody.prototype.get=function(param){this.init();var res=this.map.get(param);return res?res[0]:null},HttpUrlEncodedBody.prototype.getAll=function(param){return this.init(),this.map.get(param)||null},HttpUrlEncodedBody.prototype.params=function(){return this.init(),Array.from(this.map.keys())},HttpUrlEncodedBody.prototype.append=function(param,value){return this.clone({param:param,value:value,op:"a"})},HttpUrlEncodedBody.prototype.set=function(param,value){return this.clone({param:param,value:value,op:"s"})},HttpUrlEncodedBody.prototype.delete=function(param,value){return this.clone({param:param,value:value,op:"d"})},HttpUrlEncodedBody.prototype.toString=function(){var _this=this;return this.init(),this.params().map(function(key){var eKey=_this.encoder.encodeKey(key);return _this.map.get(key).map(function(value){return eKey+"="+_this.encoder.encodeValue(value)}).join("&")}).join("&")},HttpUrlEncodedBody.prototype.clone=function(update){var clone=new HttpUrlEncodedBody({encoder:this.encoder});return clone.cloneFrom=this.cloneFrom||this,clone.updates=(this.updates||[]).concat([update]),clone},HttpUrlEncodedBody.prototype.init=function(){var _this=this;null===this.map&&(this.map=new Map),null!==this.cloneFrom&&(this.cloneFrom.init(),this.cloneFrom.params().forEach(function(key){return _this.map.set(key,_this.cloneFrom.map.get(key))}),this.updates.forEach(function(update){switch(update.op){case"a":case"s":var base=("a"===update.op?_this.map.get(update.param):void 0)||[];base.push(update.value),_this.map.set(update.param,base);break;case"d":if(void 0===update.value){_this.map.delete(update.param);break}var base_1=_this.map.get(update.param)||[],idx=base_1.indexOf(update.value);idx!==-1&&base_1.splice(idx,1),base_1.length>0?_this.map.set(update.param,base_1):_this.map.delete(update.param)}}),this.cloneFrom=null)},HttpUrlEncodedBody}();exports.HttpBackend=HttpBackend,exports.HttpHandler=HttpHandler,exports.HttpClient=HttpClient,exports.HttpHeaders=HttpHeaders,exports.HTTP_INTERCEPTORS=HTTP_INTERCEPTORS,exports.JsonpClientBackend=JsonpClientBackend,exports.JsonpInterceptor=JsonpInterceptor,exports.HttpClientJsonpModule=HttpClientJsonpModule,exports.HttpClientModule=HttpClientModule,exports.ɵinterceptingHandler=interceptingHandler,exports.HttpRequest=HttpRequest,exports.HttpErrorResponse=HttpErrorResponse,exports.HttpEventType=HttpEventType,exports.HttpHeaderResponse=HttpHeaderResponse,exports.HttpResponse=HttpResponse,exports.HttpResponseBase=HttpResponseBase,exports.HttpStandardUrlParameterCodec=HttpStandardUrlParameterCodec,exports.HttpUrlEncodedBody=HttpUrlEncodedBody,exports.HttpXhrBackend=HttpXhrBackend,exports.XhrFactory=XhrFactory,exports.ɵa=JsonpCallbackContext,exports.ɵb=jsonpCallbackContext,exports.ɵc=BrowserXhr,Object.defineProperty(exports,"__esModule",{value:!0})});
